...
ClassTime _$ClassTimeFromJson(Map<String, dynamic> json) {
  return ClassTime(
    ...
    f: json['f'] as bool,
    s: json['s'] as bool,
    end: TimeOfDay.fromTimestamp(json['end'] as int),
    start: TimeOfDay.fromTimestamp(json['start'] as int),
  );
}
...
Map<String, dynamic> _$ClassTimeToJson(ClassTime instance) => <String, dynamic>{
      ...
      'f': instance.f,
      's': instance.s,
      'start': TimeOfDay.toTimestamp(instance.start),
      'end': TimeOfDay.toTimestamp(instance.end),
    };
